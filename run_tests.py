...
# did not import functions since the file would run run_predictions
...
file_names = ['RL-184.jpg', 'RL-185.jpg', 'RL-187.jpg']
preds = {}
for i in file_names:

    # read image using PIL:
    I = Image.open(os.path.join(data_path,i))
    
    # convert to numpy array:
    I = np.asarray(I)
    
    detect_red_light(I, plot=True)